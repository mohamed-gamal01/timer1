...
void dio_vidEnablePullUp(dio_portId_t port, dio_channelId_t channel)
{
	switch(port)
	{
		case 0: CLEAR_BIT(DIO_DDRA_REG,channel);break;
		case 1: CLEAR_BIT(DIO_DDRB_REG,channel);break;
		case 2: CLEAR_BIT(DIO_DDRC_REG,channel);break;
		case 3: CLEAR_BIT(DIO_DDRD_REG,channel);break;
		
	}
	switch(port)
	{
		case 0: SET_BIT(DIO_PORTA_REG,channel);break;
		case 1: SET_BIT(DIO_PORTB_REG,channel);break;
		case 2: SET_BIT(DIO_PORTC_REG,channel);break;
		case 3: SET_BIT(DIO_PORTD_REG,channel);break;
